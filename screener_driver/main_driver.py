from criteria.rsi_criteria import RSICriteria
from criteria.ema_criteria import EMACriteria
from criteria.avwap_resistance_criteria import AVWAPCriteria
from criteria.yearly_high_criteria import YearlyHigh
from criteria.market_cap_criteria import MarketCapCriteria
...
def apply_stock_criteria(symbol, df, criteria_list):
    ...
    for criteria in criteria_list:
        ...
        if not criteria.isSatisfied(df):
            return False
...
if __name__ == "__main__":
    criteria_list = []
    timeframe = 'D'
    criteria1 = RSICriteria(14, 75, CrossAbove(), 'D')
    criteria2 = EMACriteria(10, Above(), 'D')
    criteria3 = AVWAPCriteria(50, Above(), 'D')
